...
var savings1 = new BankAccount(112233,"Anna Smith", 1200000, 400000);
var current1 = new BankAccount(445566,"Seth Lawrence", 2000000, 0);
current.setOdLimit = 10000;
console.log(savings1);
console.log(current1);
savings.withdraw(10000);
console.log("savings balance: ",savings1.getAccBalance);
current.withdraw(2000000);
console.log("current balance: ",current1.getAccBalance);