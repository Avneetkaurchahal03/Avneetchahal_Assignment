import java.util.ArrayList;
	...
	public class Assignment5Q2 {
		...
		public static void main(String[] args) {
			News news1 = new News(1, "Mahak", "Dhiman", "comment");
	        News news2 = new News(2, "Roy", "meena", "budget");
	        News news3 = new News(1, "helen", "williams", "comment");
	        News news4 = new News(3, "Mia", "roy", "budget");
	        News news5 = new News(1, "jugghed", "joe", "comment");
	        News news6 = new News(3, "archie", "Andrew", "budget");
